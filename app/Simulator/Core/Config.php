...
final class Config
{
    public function __construct(
        ...
        public string $pageTableLocation = 'memory', 
    ...
    public function toArray(): array
    {
        return [
            ...
            'tlbEntries' => $this->tlbEntries,
            'virtualPages' => $this->virtualPages,
            'physicalFrames' => $this->physicalFrames,
            'pageTableLocation' => $this->pageTableLocation,
    ...
    public static function fromArray(array $a): self
    {
        return new self(
            ...
            pageSize: $a['pageSize'] ?? 16,
            tlbEntries: $a['tlbEntries'] ?? 4,
            virtualPages: $a['virtualPages'] ?? 16,
            physicalFrames: $a['physicalFrames'] ?? 8,
            pageTableLocation: $a['pageTableLocation'] ?? 'memory',
